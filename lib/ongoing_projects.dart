...
class OngoingProjectsPage extends StatefulWidget {
  ...
  @override
  OngoingProjectsPageState createState() => OngoingProjectsPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold
      ...
      appBar: AppBar
        ...
        title: Text('Ongoing Projects', style: TodoColors.textStyle6),
        actions: <Widget>
        [
          Container
            (
                ...
                new FloatingActionButton(
                  ...
                  onPressed: () async {
                    ...
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (_) => OngoingProjectsPage(colorIndex: widget.colorIndex, canRecruit: widget.canRecruit, res: mres,),));
                  },
                ),
              ],
            ),
