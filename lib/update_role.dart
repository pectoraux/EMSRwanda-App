...
class UpdateRolePageState extends State<UpdateRolePage> {
  static String currentRole = "Enumerator";
  final _roleNameController = TextEditingController(text: currentRole);
          ...
          PrimaryColorOverride(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText: currentRole,
                hintStyle: TodoColors.textStyle.apply(
                    color: TodoColors.baseColors[_colorIndex]),
                helperText: currentRole,
                helperStyle: TodoColors.textStyle.apply(
                    color: TodoColors.baseColors[_colorIndex]),
                labelText: 'Role Name',
                labelStyle: TodoColors.textStyle2,
                border: CutCornersBorder(),
              ),
              onChanged: (text) { currentRole = text; },
            ),
          ),
